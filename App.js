    ...
    discours: {
        ...
        contenu: `
            <style>
                ...
                .styled-table th, .styled-table td { padding: 8px; border-bottom: 1px solid #dddddd; font-size: 11px; }
            ...
            <div class="table-container">
                <table class="styled-table">
                    ...
                    <tbody>
                        ...
                        <tr><td>13/06</td><td>Pourquoi craindre le vrai Dieu</td><td>BENONY Christian</td><td>ADHEL Gilbert</td><td>ADHEL Gilbert</td><td>-</td></tr>
